...
const buttonVariants = cva(
  'inline-flex items-center justify-center whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        default:
          'bg-gradient-primary text-white shadow-lg shadow-primary/25 hover:shadow-primary/40 hover:scale-[1.02] active:scale-[0.98]',
        secondary:
          'bg-panel border border-border text-foreground hover:bg-panel-hover hover:border-border-light',
        ghost:
          'text-muted hover:text-foreground hover:bg-panel',
        outline:
          'border border-border bg-transparent text-foreground hover:bg-panel hover:border-border-light',
      },
      size: {
